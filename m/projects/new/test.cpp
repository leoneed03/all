...
TEST(AllTests, determinant_test14)
{
    int size = 3;
...
for (int i = 0; i < size; i++) {
    ...
    unsigned int n_search_time = n_end_time - n_start_time;
    std::cout << "PRINT TIME: " << n_search_time/1000.0 << std::endl;
}
TEST(AllTests, determinant_test16)
{
    int size = 3;
    unsigned int a_start_time = clock();
    for (int i = 0; i < size; i++)
	print();
    unsigned int a_end_time = clock();
    unsigned int a_search_time = a_end_time - a_start_time;
    std::cout << "PRINT 0 threads TIME: " << a_search_time/1000.0 << std::endl;
}
TEST(AllTests, determinant_test15)
{
   int size = 3;
std::thread my_threads[size];
    unsigned int n_start_time = clock();
    ...
    for (int i = 0; i < size; i++)
	my_threads[i] = std::thread(print_me);
...
for (int i = 0; i < size; i++) {
    ...
    unsigned int n_search_time = n_end_time - n_start_time;
    std::cout << "PRINT_ME TIME: " << n_search_time/1000.0 << std::endl;
}
